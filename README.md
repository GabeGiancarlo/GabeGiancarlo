...
I’m passionate about building secure, innovative, and user-friendly applications — from precision drone systems for viticulture to LoRax, AI-driven security tools, and creative Swift apps. I like blending **technology, design, and problem-solving** into projects that have real-world impact.
...
### [LoRax](https://github.com/GabeGiancarlo/LoRax)  
A long-range LoRa-based communication stack and toolkit built for low-power mesh networks — focused on reliability, extensibility, and real-world deployment. Ideal for IoT telemetry, remote sensing, and resilient messaging across distributed devices.  
**Tech:** LoRa, C/C++, Embedded Linux, Mesh Networking, Python tooling
...
- Improving **LoRax** for production deployments and testing on real hardware  
